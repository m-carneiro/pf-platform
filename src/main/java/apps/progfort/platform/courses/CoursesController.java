...
public class CoursesController {
  ...
  updateCourse(@PathVariable String id, @RequestBody CoursesDTO coursesDTO) {
  ...
  public ResponseEntity<CourseActivated>
  activateCourse(@PathVariable String id) {
    return ResponseEntity.ok(coursesService.activateCourse(id));
  }

  @PutMapping("/deactivate/{id}")
  public ResponseEntity<CourseDeactivated>
  deactivateCourse(@PathVariable String id) {
