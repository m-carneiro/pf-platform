...
public class LastViewedCourseRegistry {
  ...
  @OneToOne private Courses lastViewedCourse;

  private LocalDateTime lastViewedDate;

  public LastViewedCourseRegistry() {}

  public LastViewedCourseRegistry(String id, Students student,
  ...
  public Courses getLastViewedCourse() { return lastViewedCourse; }
